...
namespace CSURToolBox
{
    public class Parser
    {
        ...
        public static byte TryNextSymmetry(int symmetry, int fromSelected, int toSelected, bool hasSidewalk, bool hasBike)
        {
            ...
            switch (symmetry)
            {
                case 255:
                    ...
                    nextSymmetry = 0;
                    nextModule = NetInfoFromUI(fromSelected, toSelected, nextSymmetry, hasSidewalk, hasBike);
                    if (nextModule == null)
                    {
                        nextSymmetry = 127;
                        nextModule = NetInfoFromUI(fromSelected, toSelected, nextSymmetry, hasSidewalk, hasBike);
